...
jQuery(document).ready(function(){
	...
	$(".assignRole").click(function(){
		...
		jQuery.ajax({
	        ...
	        url: '${request.contextPath}/management/security/organization/create/organizationRole?organization.id=${organizationId}&role.id=' + roleId + '&priority=' + priority,
	        error: function() { 
